...
def dist1(file_name, n=1):
    with open(file_name, 'r') as f:
        hypn = [line.strip() for line in f.readlines()]
...
# def compute_quality_in_conditional_gen(task_name, file_name,test_data):
